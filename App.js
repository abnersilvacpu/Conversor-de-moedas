...
export default function App() {
  ...
  if(loading){
    return(
      <View style={{flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#101215'}}>
  ...
  return (
    <View style={styles.container}>
      ...
      {valorConvertido !== 0 && (
        ...
        <Text style={{fontSize: 18, margin: 8, fontStyle: '500', color: '#000'}}>corresponde a</Text>
        <Text style={styles.valorConvertido}>{valorConvertido}</Text>
        </View>
      )}

      {valorConvertido !== 0 && (
        <TouchableOpacity style={styles.botaoAreaVoltar} onPress={() => setValorConvertido(0)}>
